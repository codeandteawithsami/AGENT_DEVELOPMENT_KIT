...
# Defines the Post Reviewer Agent
post_reviewer = LlmAgent(
    ...
    {current_post}
    """,
    description="Reviews post quality and provides feedback on what to improve or exists the loop if requirements are met",
