...
This agent generates the intial LinkedIn post before refinement.
"""
...
initial_post_generator = LlmAgent(
    ...
    Your task is to create a LinkedIn post about an Agent Development Kit (ADK) tutorial by @SamiullahSaleem.
    ...
    4. Mention/tag of @SamiullahSaleem
