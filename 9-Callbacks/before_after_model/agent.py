...
def after_model_callback(
    ...
    for origional, replacements in replacements.items():
        if origional in modified_text.lower():
            modified_text = modified_text.replace(origional, replacements)
            modified_text = modified_text.replace(
                origional.capitalize(), replacements.capitalize()
            )
            modified = True
    ...
    # Return None to use the origional response
    return None
